...
print("n (public key) is: ", public_key.public_numbers().n)
print("e is :", public_key.public_numbers().e)
print("d is ", private_key.private_numbers().d)
print(type(public_key.public_numbers().n))
